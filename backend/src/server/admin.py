...
def main():
  ...
  answer = Prompt.ask("Enter action to perform", choices=["1","2","3","4"], default="1")
...
def update_privileges():
  ...
  info(f'Setting user privileges for {user_instance.user_name} to {UserPrivileges(privileges).name}')
