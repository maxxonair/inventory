...
Minimal inventory management system to track physical assets in a digital database. Assets are uniquely identified by their QR code labels - automatically generated by this tool - allowing to manage and track storage location and borrowing status. 
